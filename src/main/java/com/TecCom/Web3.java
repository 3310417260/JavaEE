...
public class Web3 {
    ...
    private static final String tablename = "web3.";
    private static final String controllername = "/web3";
    private static final String controllernamefor2 = "/web3/";
    ...
    public String bbscontext(@PathVariable int num, Map<String, Object> map) {
        ...
        Iterable<Boardcontextwith> iterablewith = sqlSession.selectList(tablename + "getwithweb3", num);

        map.put("context", iterable);
        map.put("contextwith", iterablewith);
        map.put("intodbwith", tablename+"into_web3with");
        return "bbscontext";
    }
    ...
    public String index(@PathVariable int num, Map<String, Object> map) {
        ...
        List<Boardcontext> userlist = sqlSession.selectList(tablename + "getallweb3");
        ...
        Iterable<Boardcontext> iterable = sqlSession.selectList(tablename + "getallweb3e");
        map.put("context", iterable);
    ...
    public String bbs_anime(Map<String, Object> map) {
        ...
        if (basesize <= 0) {
            ...
            Iterable<Boardcontext> iterable = sqlSession.selectList(tablename + "getallweb3");
            map.put("context", iterable);
            map.put("justforurl", controllernamefor2);
            map.put("list", list);
            map.put("boardname", controllernamefor2 + "page/");
