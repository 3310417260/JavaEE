...
public class Exp {
    ...
    private static final String tablename = "exp.";
    private static final String controllername = "/exp";
    private static final String controllernamefor2 = "/exp/";
    ...
    public String bbscontext(@PathVariable int num, Map<String, Object> map) {
        ...
        Iterable<Boardcontextwith> iterablewith = sqlSession.selectList(tablename + "getwithexp", num);

        map.put("context", iterable);
        map.put("contextwith", iterablewith);
        map.put("intodbwith", tablename+"into_expwith");
        return "bbscontext";
    }
    ...
    public String index(@PathVariable int num, Map<String, Object> map) {
        ...
        List<Boardcontext> userlist = sqlSession.selectList(tablename + "getallexp");
        ...
        Iterable<Boardcontext> iterable = sqlSession.selectList(tablename + "getallexp");
        map.put("context", iterable);
