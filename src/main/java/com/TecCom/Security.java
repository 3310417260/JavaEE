...
public class Security {
    ...
    private static final String tablename = "security.";
    private static final String controllername = "/security";
    private static final String controllernamefor2 = "/security/";
    ...
    public String bbscontext(@PathVariable int num, Map<String, Object> map) {
        ...
        Iterable<Boardcontextwith> iterablewith = sqlSession.selectList(tablename + "getwithsecurity", num);

        map.put("context", iterable);
        map.put("contextwith", iterablewith);
        map.put("intodbwith", tablename+"into_securitywith");
        return "bbscontext";
    }
    ...
    public String index(@PathVariable int num, Map<String, Object> map) {
        ...
        List<Boardcontext> userlist = sqlSession.selectList(tablename + "getallsecurity");
        ...
        Iterable<Boardcontext> iterable = sqlSession.selectList(tablename + "getallsecurity");
        map.put("context", iterable);
