...
public class Dev {
    ...
    private static final String tablename = "dev.";
    private static final String controllername = "/dev";
    private static final String controllernamefor2 = "/dev/";
    ...
    public String bbscontext(@PathVariable int num, Map<String, Object> map) {
        ...
        Iterable<Boardcontextwith> iterablewith = sqlSession.selectList(tablename + "getwithdev", num);

        map.put("context", iterable);
        map.put("contextwith", iterablewith);
        map.put("intodbwith", tablename+"into_devwith");
        return "bbscontext";
    }
    ...
    public String index(@PathVariable int num, Map<String, Object> map) {
        ...
        List<Boardcontext> userlist = sqlSession.selectList(tablename + "getalldev");
        ...
        Iterable<Boardcontext> iterable = sqlSession.selectList(tablename + "getalldev");
        map.put("context", iterable);
